...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'auteurs_vous_suivez' => 'Les poulpes que vous suivez',

	// B
	'beta_publique' => '<strong>Octopouce est en beta publique.</strong><br />Vous pouvez vous inscrire et participer, merci pour votre patience et votre bonne volonté durant cette phase.',
	...
	'people' => 'poulpes',
	'profil' => 'préférences',
	'profil_alerte_conversations' => '<b>conversations</b> / quelqu’un répond à un pouit auquel j’ai moi-même répondu',
	'profil_alerte_dubien' => '<b>un ami qui vous veut du bien</b> / quelqu’un me suit',
	'profil_alerte_mes_billets' => '<b>mes pouits</b> / recevoir une copie de mes propres pouits',
	'profil_alerte_nolife' => '<b>nolife</b> / un poulpe que je suis répond à n’importe quel pouit',
	'profil_alerte_nouveaux_billets' => '<b>nouveaux pouits</b> / un nouveau pouit est posté par un poulpe que je suis',
	'profil_alerte_partage' => '<b>partage</b> / quelqu’un a partagé un de mes pouits',
	'profil_alerte_reponse_partage' => '<b>réponses à un partage</b> / quelqu’un répond à un pouit que j’ai partagé',
	'profil_alerte_reponses' => '<b>réponses à mes pouits</b> / quelqu’un répond à un de mes pouits',
	...
	'profil_logo' => 'Logo du poulpe (carré)',
	...
	'slogan_texte' => '<strong>Participez à la discussion !</strong> Sur Seenthis, vous pouvez référencer des articles, les commenter, écrire des billets, discuter avec vos amis, suivre les poulpes qui vous intéressent...',
